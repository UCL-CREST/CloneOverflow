...
echo "Reading from $1, analysing $2 using settings $3"
...
while read i; do    
	...
	if [ $3 = "default" ]; then
        	java -jar -Xmx1024m /home/cragkhit/Documents/CloneOverflow/tools/simian/bin/simian-2.3.35.jar "/dev/shm/cragkhit/**/*.java" > "${RAM_PROJECT_FOLDER}"/simian_results/"${BASENAME}".txt
        elif [ $3 = "fse13" ]; then
