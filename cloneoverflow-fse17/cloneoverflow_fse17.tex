...
\begin{abstract}
 ...
 \FIXME{Outdated.~Revise this last}~ Online code clones are code fragments that are copied from software
...
research questions:
\begin{description}
\item[RQ1 (Online code clones):] \textit{To what extent is source
...
problem. 
\item[RQ2 (Patterns of online code clones):] \textit{Why do online
...
\item[RQ3 (Outdated online code clones):] \textit{Are
...
them. 
\item[RQ4 (Software licensing violation):] \textit{Do
...
al.~\cite{An2017} reports 1,279 cases of potential license violations
