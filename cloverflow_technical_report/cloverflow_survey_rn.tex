...
\noindent\fbox{%
	\parbox[c][0.5cm]{0.98\textwidth}{%
		\textit{How frequently do or did you answer questions on Stack Overflow?}
	}%
}
\vspace{0.5cm}
...
\noindent\fbox{%
	\parbox[c][0.5cm]{0.98\textwidth}{%
		\textit{How frequently do or did you include code snippets in your answers on Stack Overflow?}
	}%
}
\vspace{0.5cm}
...
\noindent\fbox{%
	\parbox[c][0.5cm]{0.98\textwidth}{%
		\textit{Where did the code snippets in your answers come from?}
	}%
}
\vspace{0.5cm}
...
\noindent\fbox{%
	\parbox[c][1cm]{0.98\textwidth}{%
		\textit{Outdated code occurs when code snippets in your answers are no longer up-to-date with the latest version of the software you copied the code from. Have you ever been notified of outdated code in your Stack Overflow answers?}
	}%
}
\vspace{0.5cm}
...
\noindent\fbox{%
	\parbox[c][0.5cm]{0.98\textwidth}{%
		\textit{How frequently were you notified of outdated or deprecated code in your Stack
			Overflow answers?}
	}%
}
\vspace{0.5cm}
...
\noindent\fbox{%
	\parbox[c][0.5cm]{0.98\textwidth}{%
		\textit{Do you usually include a software license in your code snippets on Stack Overflow?}
	}%
}
\vspace{0.5cm}
...
\begin{figure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=.85\linewidth]{survey_license_check_1}
		\caption{Group 1}
		\label{fig:survey_license_check_1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=.85\linewidth]{survey_license_check_2}
		\caption{Group 2}
