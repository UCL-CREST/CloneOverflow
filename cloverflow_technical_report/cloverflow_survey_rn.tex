...
\title{Awareness and Experience of Developers to\\ Outdated and License-incompatible Code on Stack Overflow:\\ An Online Survey}
%\subtitle{Do you have a subtitle?\\ If so, write it here}

\titlerunning{SO Developers awareness: Outdated and License-incompatible Code}        % if too long for running head
...
software licenses in their snippets and 69\% never check for licensing compatibility
...
Moreover, 66\% of the participants do not check for licensing compatibility between
...
visitors, to the problem of outdated and license-incompatible code snippets.
\end{abstract}
...
incompatibility are ramifications by code cloning, i.e.~reusing source code by copying
...
cloning leads to software license incompatibility among different systems.
...
upvotes for good questions and useful answers. \FIXME{I don't understand the
	sentence. @Jens Ok now?:} For example, they gain reputation when they receives an upvote for
their question (+5), an upvote for their answer (+10), or a marking as accepted answer (+15)\footnote{Stack
...
\vspace{0.5cm} \noindent\fbox{%
	\parbox[c][1.5cm]{0.98\textwidth}{%
		\textit{For RQ3, approximately 62\% of our participants are aware of CC BY-SA
			...
			percent never check for licensing compatibility when they copy code snippets to
...
\vspace{0.5cm} \noindent\fbox{%
	...
	licensing compatibility between Stack Overflow code snippets and their projects.
...
99\%) nor check of license compatibility between their code snippet's and Stack
...
third of the clones from 10 most frequently referenced Java code snippets on Stack
