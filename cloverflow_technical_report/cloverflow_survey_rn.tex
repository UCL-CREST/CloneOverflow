...
\subsubsection*{RQ4: Where do the developers search for programming solutions?}
...
\vspace{0.5cm} \noindent\fbox{%
	...
	from Stack Overflow at least once a week. The copy code from Stack Overflow
    because they can be found easily from search engine, solve similar problems to
    their problems, provide helpful context, and offer voting and accepted answers.}
	}%
} \vspace{0.5cm}
