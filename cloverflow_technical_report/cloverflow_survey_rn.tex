...
\vspace{0.5cm} \noindent\fbox{%
	\parbox[c][2.2cm]{0.98\textwidth}{%
		\textit{For RQ4, our survey results show that 57 out of 87 Stack Overflow
			...
			participants experience the problems from more than 80\% of the copied snippets and
			sixteen participants face the problems from 40--60\% of the reused code. The
