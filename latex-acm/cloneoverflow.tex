...
\begin{table*}
	...
	\begin{tabular}{|l"r|r|r|r|r|r|r|r"r|r|r|r|r|r|r"r|r|r|r|}
		...
		\multirow{1}{*}{\textit{Simian$_{df}$}} & 71 & 0 & 318 & 11 & \textbf{401} & 138 & 210 & 37 & 182 & 64 & 148 & \textbf{394} & 120 & 191 & 45 & \textbf{795} & 246 & 386 & 55 \\
		\hline
...
%\begin{table}
%	\centering
%	\caption{Distribution of classification category A--F according to good- and \textit{ok-}match pairs. S denotes Simian and N denotes NiCad tool.}
...
%		\hline
%		\hline
%		\multicolumn{9}{|c|}{good-match pairs} \\
%		\hline
...
%%		Category   																										& A   	& 	A' 	& 	B  & C	   & D   	&	E   &	F   & Total  \\
%%		\hline
%		\multicolumn{9}{|c|}{ok-match pairs} \\
%		\hline
...
\begin{table*}
	\centering
	\caption{53 code clones in Stack Overflow that were altered, rewritten, or removed from the project after posted and their respective licenses}
