...
empirical studies on the topic~\cite{An2017,Abdalkareem2017,Baltes2018}, especially
...
\texttt{humanReadableInt()} method from \textsf{Hadoop} appeared in two popular Java
...
retrieved them from Stack Overflow, other websites, or from \textsf{Hadoop} code base
...
the \textsf{Hadoop} code base. The developers of Apache Hive found that the method was not used anywhere
...
posted on Stack Overflow. One QS clone pair posted by a \textsf{JFreeChart} developer
...
\begin{table}
	...
	\begin{tabular}{lrrrrr}
		...
		\bottomrule
	\end{tabular}
	\caption{Clones of the 214 Stack Overflow missing-license code snippets in 130,719 GitHub projects}
	\label{tab:license_github}
\end{table}

Note that the code snippets could potentially violate the license, but do
not necessarily do so. In the example where the \textsf{JFreeChart}
...
based on human judgement (e.g., comments in the code, natural text in the question and
...
from \textsf{Hadoop} since it contains two terms of the project name (Hadoop) and a class name (WritableComparator)
in it.
...
Abdalkareem et al.~\cite{Abdalkareem2017}, Baltes et al.~\cite{Baltes2018},
...
Baltes et al.~\cite{Baltes2018} discovered that only 23.2\% of the clones in GitHub projects
from the 10 most frequently referenced Java code snippets on Stack
Overflow contain attributions.
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{cragkhit.png}}]{Chaiyong Ragkhitwetsagul}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{jkrinke.png}}]{Jens Krinke}
...
is Research Assistant in the Computer Science Department at State University of Ceara. He received his PhD degree at University College London, where he was part of the Centre for Research on Evolution, Search, and Testing (CREST) and Software Systems Engineering (SSE) Group. His research interests include software architecture, search-based software engineering, mining software repositories, and modern code review.
\end{IEEEbiography}
%\vspace{-1cm}
