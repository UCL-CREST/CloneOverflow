...
\begin{table}
	...
	%\small
	\resizebox{\linewidth}{!}{
		\begin{tabular}{lp{2.5cm}p{2.5cm}rrr}
			\toprule
			...
			& No license & GPL/v2/2+/3+ & 8 & 48 & 7 \\ 
			& No license & LesserGPL/v2.1+/3+ & 16 & & 9 \\ 			
...
locations. The results are shown in \Cref{fig:survey_snippet_source}. Looking at
...
\Cref{tab:survey_license_include}) due to several reasons. First, some answerers chose
