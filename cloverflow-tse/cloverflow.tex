...
this study as the two problems are still under explored compared to code smells~\cite{Tufano2015} or vulnerabilities~\cite{Acar2016,Fischer2017}.
...
\Cref{fig:boxplotclonesize}. We found that the distribution of true clones; QS,
...
is also different from case to case or from country to country.
