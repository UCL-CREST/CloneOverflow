...
projects. We selected SourcererCC with with the same settings (see \Cref{tab:clone_config}) 
...
Hadoop code base. The bug report in Apache Hive is still
unfixed.
...
of 7,207 clone pairs. There were 95 pairs from 10 Qualitas projects on
GitHub and 7,112 pairs from 2,427 other projects. From
...
We used the Ninka tool to automatically identify software license of the 7,207 cloned
code snippets. 
