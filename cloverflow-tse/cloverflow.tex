...
(33\% response rate) and found that 69 of them (34.5\%) have never been notified of
outdated code in the answers and 26 of them (19.8\%) rarely or never fix the outdated
...
%projects with minimal modifications. 
...
There are 338 (15\%) conflicts between 
true and false clones (QS, SQ, EX, UD, BP, IN vs.~AC). The other 270 pairs (12\%) are 
...
\begin{table}
	...
	\begin{tabular}{c@{~~}p{7.35cm}}
		...
		EX & Cloned from an external source \textit{X} to Stack Overflow\newline (X $\rightarrow$ S). \\
