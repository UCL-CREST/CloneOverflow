...
\begin{table}
	...
	\begin{tabular}{p{2.2cm}rrrr}
		...
		\midrule
		Reported clones & 2,302 & 590 & 63 & 53.10\% \\ 
		\midrule
		TP from manual validation & 2,076 & 560 & 59 & 54.22\% \\ % <-- for avg. cloned ratio, use scripts in ~/Downloads/stackoverflow/scripts/checking
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table*}
	...
	\begin{tabular}{rrrrrrrr}
		\toprule
		QS & SQ & EX & UD & BP & IN & AC & Total \\ 
		\midrule
		239 (149) & 1 (1) & 208 (119) & 107 (65) & 1,505 (217) & 16 (9) & 226 (53) & 2,302 (560) \\
		\bottomrule
	\end{tabular} 
	%}
\end{table*}
