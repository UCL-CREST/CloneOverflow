...
pairs will hinder the full manual validation of the clones.
% and one needs to
...
was posted on Stack Overflow as shown in~\ref{fig:boxplotcloneage}.
...
source systems not in Qualitas (e.g.,\ \textsf{Mozilla
	Rhino}), 10 pairs from Java official documentation from Sun
...
that there were 34 posts which contained newer answers and 5 posts which contained answers with a higher number of
...
of them. As shown in \Cref{tab:outdated_github}, out of the 102 cloned snippets,
...
We found only a small number of toxic outdated code snippets in open source projects on
...
On the other hand, the missing licensing statements of online code clones on
...
on Stack Overflow were a good source of information to decide the direction of
...
shows that although the developers are aware of outdated code in their answers,
