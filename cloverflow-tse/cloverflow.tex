...
Stack Overflow accepted answers in this study to focus on code snippets that
solve problems in the question and are often showed on top of the answer list.
While most of the time they are also the highest voted answers, there is some
time that they are not. We plan to incorporate the highest voted answers in the
future work.
% We also
...
Abdalkareem et al.~\cite{Abdalkareem2017}, and Baltest et al.~\cite{Baltes2017}. 
...
% \begin{IEEEbiographynophoto}{Chaiyong Ragkhitwetsagul}
% Biography text here.
% \end{IEEEbiographynophoto}

% % if you will not have a photo at all:
% \begin{IEEEbiographynophoto}{Jens Krinke}
% Biography text here.
% \end{IEEEbiographynophoto}

% \begin{IEEEbiographynophoto}{Matheus Paixao}
% Biography text here.
% \end{IEEEbiographynophoto}
