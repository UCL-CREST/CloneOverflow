...
highly-ranked Stack Overflow users. We found that they cloned code snippets
...
license in their snippets and 69\% never check for licensing conflicts between
the cloned code snippets and Stack Overflow's CC BY-SA 3.0. On the other hand, we also
surveyed 87 Stack Overflow visitors (i.e.~information seekers) on their
experiences to toxic code snippets on Stack Overflow. Sixty-six percent of the
visitors experienced a problem from reusing Stack Overflow code snippets. The
visitors are generally not aware of the CC BY-SA 3.0 license, and more than
...
\begin{boxquote}
	To answer RQ 5.1, regarding outdated code, although most of the Stack Overflow answerers are aware that their code
...
During the manual investigation of 2,289 clone pairs, we identified 226 pairs
...
\begin{boxquote}
	To answer RQ2, we found more than half (53\%) of Qualitas projects to share
	similar code with Stack Overflow code snippets. In the manually confirmed 
	data set of 2,289 clone pairs, we found 2,076 pairs as true positives which 
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{boxplot_clone_size}
