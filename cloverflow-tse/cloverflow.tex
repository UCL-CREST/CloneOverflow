...
from source code of Java SDK, 18 pairs from websites, 15 pairs from open
source systems, 11 pairs from Java official documentations from Sun
...
\begin{table*}
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{cc|lcp{4cm}@{}rrc|lc@{}c}
			...
			\midrule
			2513183 & 25-Mar-10 & eclipse & 4.3 & GenerateToStringAction.java & 113 & 166 & 25-Jun-13 & Bug 439874 & \textit{S} & 17-Mar-15 \\
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{lp{2.2cm}lrrr}
			...
			Compatible & Apache-2 & Apache-2 & 1 & & \\
								  & EPLv1 & EPLv1 & 2 & & \\
								  & No license & No license	& 20 & & \\
			\midrule
			\multicolumn{3}{l}{Total} & 23 & & \\
			\midrule
			Incompat. & No license & EPLv1	& 10 & & \\
								& No license & GPLv2/2+/3+	& 7 & & \\
								& No license & AGPLv3 & 1 & & \\
								& No license & Apache-2 & 46 & & \\
								& No license & BSD/BSD3	& 4 & & \\
								& No license & LesserGPL/v2.1+/v3+ & 17 & & \\
								& spdxBSD3 & LesserGPLv2.1+	& 1 & & \\
			\midrule
			\multicolumn{3}{l}{Total} & 86 & & \\
			\bottomrule
		\end{tabular} 
	}
\end{table}
...
terms while their clone counterparts in Qualitas projects do. 
Pleaste note that the
results here are analysed at file level, not clone fragment, thus there are some
clone pairs that share the same result and we combine them into a single pair.
The summary of
