...
Then, we used the Ninka tool to automatically identify
software licenses from the reported cloned snippets. Shown in
...
license. One snippets had the AGPLv3 license while the original had the Apache-2
...
projects, (2) there is a large number of toxic code snippets caused by missing
...
\rcomment{ \begin{enumerate} \item Table 1 has a median column. Median of what?
		...
		as part of the clone detection process? \item Typo: ``how much the community
...
\rcomment{ \textbf{The definition of toxic code snippets:} I understand that the
	...
	harmful for reuse and, \textbf{in several cases}, are caused by online...''. A
...
the answer is specifically for Spring 3.1. Moroever, another user posted a
comment on the answer of the post no.~801935 that the code snippet is not of
...
\rcomment{ I do believe the survey results from the StackOverflow contributors
	actually provides more meaningful insights then then the clone detection itself,
