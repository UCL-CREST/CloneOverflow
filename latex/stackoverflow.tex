...
\begin{table}[H]
	...
	\begin{tabular}{|l"r|r|r|r|r|r|r|r"r|r|r|r|r|r|r"r|r|r|r|}
		...
		\hline 
		\multirow{1}{*}{\textit{good-match(0.7)}}  & 1 & 0 & 1  & 3 & \textbf{5} & 5 & 4 & 4 & 26  & 6 & 1369 & \textbf{1401} & 56 & 416 & 31 & \textbf{1406} & 61 & 420 & 32 \\
		\multirow{1}{*}{\textit{ok-match(0.7)}}  & 8 & 0 & 36  & 8 & \textbf{52} & 8 & 10 & 6 & 474 & 57 & 81 & \textbf{612} & 77 & 62 & 17 & \textbf{664} & 84 & 70 & 20 \\
		\hline
	\end{tabular} 
\end{table}
