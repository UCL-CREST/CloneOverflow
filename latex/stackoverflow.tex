...
\begin{table}[H]
	...
	\begin{tabular}{|l|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{6mm}|R{8mm}|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{3mm}|R{8mm}|}
		...
		\hline 
		\multirow{1}{*}{\textit{Simian$_{df}$}} & 25 & 0 & 15 & 3 & 29 & 9 & 121 & 9,272 & & & & & & & & \\ \cline{2-8}
		\hline
		\multirow{1}{*}{\textit{NiCad$_{df}$}} & 0  & 0 & 1 & 0 & 34 & 1 & 186 & 6,831 & & & & & & & & \\ \cline{2-8}
		\hline
		TP/FP & \multicolumn{4}{c|}{44} & \multicolumn{3}{c|}{380} & 424 & & & & & & & &  \\ 
		
		\hline
		Unique SO fragments & \multicolumn{4}{c|}{44} & \multicolumn{3}{c|}{380} & & \multicolumn{4}{c|}{??} & & & & \\
		\hline
		Unique Q files & \multicolumn{4}{c|}{44} & \multicolumn{3}{c|}{380} & & \multicolumn{4}{c|}{??} & & & & \\
		\hline
		Unique Q files & \multicolumn{4}{c|}{44} & \multicolumn{3}{c|}{380} & & \multicolumn{4}{c|}{??} & & & & \\
		\hline
	\end{tabular} 
