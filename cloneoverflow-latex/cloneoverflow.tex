...
\begin{abstract}
  ...
  curated Qualitas corpus. We discovered and investigated 51,926
...
\begin{table}
\caption{FIXME Maybe merge with Table 7?}
\label{tab:snippets}
\centering
\begin{tabular}{l|rrr}
  & Pairs & Snippets & Projects \\
\hline
...
manually investigated 31,946 clones pairs are clones between FIXME
Stack Overflow snippets and FIXME Qualitas projects.
