...
\begin{table}
	...
	\begin{tabular}{l|p{2.4cm}|r|r|r}
		...
		\hline
		\multirow{1}{*}{\textit{Simian$_{df}$}} & $minline \geq 10$ \newline \& reg.~expressions & \multirow{2}{*}{67,570} & \multirow{2}{*}{2,546} & \multirow{2}{*}{871} \\ %140 + 1482 + 926
		\hline
%		\multirow{1}{*}{\textit{NiCad$_{df}$}-1} & 7040  & 226 & 6700 & 114 \\
%		\multirow{1}{*}{\textit{NiCad$_{df}$}-2} & 22187  & 152 & 21990 & 45 \\
		\multirow{1}{*}{\textit{NiCad$_{df}$}} & $similarity \geq 80\%$ \newline (i.e.~UPI=0.2) & \multirow{2}{*}{229,176} & \multirow{2}{*}{450} & \multirow{2}{*}{168} \\
		\hline
		\multicolumn{2}{l|}{Total} & 296,746 & 2,996 & 1,039 \\
		\hline
	\end{tabular} %
	}
\end{table}
