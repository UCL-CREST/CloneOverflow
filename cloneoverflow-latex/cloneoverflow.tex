...
framework depicted in \Cref{fig:exp_framework}. We processed two
...
file.
% GCF provides a common format for clone reports which enables other
% clone detectors to be adopted, if needed, without any changes in the
% analysis.
...
% risk of returning false positives non-meaningful clones is
% increased.
...
Overflow. %hence resulting in outdated clones on Stack Overflow.
