...
combinations. For the 2,308 \textit{good} pairs, there are 92 Stack Overflow snippets
which are associated with 66 Qualitas projects. The 11,749 \textit{ok} 
pairs are clones between 136 Stack Overflow snippets and 39 Qualitas 
projects. 

Moreover, for the disagreed pairs, we found 17,081 clone pairs reported by $S_D$
are clones between 471 Stack Overflow snippets and 76 Qualitas projects and 
88 $N_D$ clone pairs are clones between 77 Stack Overflow snippets and 29
Qualitas projects.
...
shown in \Cref{fig:outdated}, \textsf{spring}
have the highest number of 17 outdated pairs, followed by 7 from
\textsf{hibernate} and \textsf{hadoop}, and 6 from \textsf{junit}. Besides the example of
...
\begin{table*}
	...
	\resizebox{2.1\columnwidth}{!}{%
		\begin{tabular}{l|l|l|l|p{5.1cm}|r|r|l|c|l}
		 \hline
