...
\textbf{To answer RQ2, we used our patterns of online code cloning to classified 31,946 clone pairs. Our results showed that although most of the clone pairs were boiler-plate code (28,642), clones from inheritance/interface (109), or accidental clones (2,525); there were 670 pairs that were very interesting. 110 pairs had strong evidences to be cloned from Qualitas to Stack Overflow. 382 were non-trivial clones but without strong evidence of clone direction. 178 pairs were found to be cloned from external sources outside Qualitas projects. Lastly, we did not find any clone pairs in the direction from Stack Overflow to Qualitas.}
...
\Cref{fig:outdated} shows the findings of outdated online clones on Stack Overflow. We discovered 59 outdated online clone pairs out of 110 pairs. \texttt{spring} and \texttt{hibernate} have the maximum number of 20 outdated pairs, followed by 15 from \texttt{eclipse}, and 12 from \texttt{hadoop}. An example of outdated code in \texttt{hadoop}'s \texttt{WritableComparator.java} has already been shown in \Cref{fig:before-after}. We also found a few outdated code which contained heavy modifications. For example, the code snippet in Stack Overflow post 23520731, a copy of \texttt{SchemaUpdate.java} in \texttt{hibernate}, it had been heavily modified in the latest version (as shown in \Cref{fig:hibernate_outdated_code}). We also found 3 ``dead'' snippets. These snippets did not have their originals in the latest version of the projects anymore. For example, the snippet in Stack Overflow post 3758110, a copy of \texttt{DefaultAnnotationHandlerMapping.java} in \texttt{spring}, was deleted in commit \texttt{02a4473c62d8240837bec297f0a1f3cb67ef8a7b} by Chris Beams on 20th January 2012 at 22:51:02, two years after it was posted. %The latest version of Spring does not contain the file anymore. 
...
\textbf{For RQ3, our results show that more than half (59) of QS clone pairs on Stack Overflow are outdated. We observed that the newer versions of these outdated snippets contained various changes ranging from a slight modifications of variable names or method names, added or deleted statements, to a fully rewritten code with new method signatures. Moreover, we found three dead snippets. They do not exist any more in the latest version. Both outdated and dead online clone snippets are questionable for reuse.} %These changes did not reflect They might later find out that the copied code does not work any more due to different API versions. Even worse, they might also introduce bugs or vulnerabilities into their software.  }
...
%\begin{table*}
%	\centering
%	\caption{62 QS outdated online code clones. Clones can be outdated by modifications ($M$), deletion ($D$), and rewriting ($R$).}
%	\label{tab:stale_code_details}
%	\scriptsize
%	\resizebox{2.1\columnwidth}{!}{%
%	\begin{tabular}{r|l|c|p{4.5cm}|r|r|l|c|l}
%		\hline 
%		No. & Project & Ver. & File & Start & End & SO Post & Cause & C$_{\textit{\textrm{date}}}$ \\
%		\hline
...
%			3 & \texttt{eclipse-SDK} & & GenerateToStringAction.java  & 113 & 166 & 2513183 & $M$  &  2015-03-17 \\
%			4 & \texttt{eclipse-SDK} & & GenerateToStringAction.java  & 117 & 126 &  2513183	& $M$  &  2015-03-17 \\
%			5 & \texttt{eclipse-SDK} & & GenerateToStringAction.java  & 143 & 165 &  2513183	& $M$  &  2015-03-17 \\
%			6 & \texttt{eclipse-SDK} & & GenerateToStringAction.java  & 178 & 187 &  2513183	& $M$  & 2011-03-01 \\
%			7 & \texttt{eclipse-SDK} & & WizardDialog.java  & 377 & 394 &   11861598	& $M$  &  2011-02-03 \\
%			8 & \texttt{hadoop} & 1.0.0 & DBCountPageView.java  & 275 & 287 & 21702608 & $M$  & 2011-06-12 \\
%			9 & \texttt{hadoop} & 1.0.0 & DBCountPageView.java  & 289 & 309 & 21702608 & $M$  & 2011-06-12 \\
%			10 & \texttt{hadoop} & 1.0.0 & JobSubmissionFiles.java  & 46 & 55 & 14845581 & $M$  & 2012-06-25 \\
%			11 & \texttt{hadoop} & 1.0.0 & mapred/../LineRecordReader.java  & 47 & 60 & 16180910 & $M$  & 2011-07-25 \\
%			12 & \texttt{hadoop} & 1.0.0 & mapreduce/../LineRecordReader.java  & 75 & 99 & 16180910 & $M$  & 2011-07-25 \\
%			13 & \texttt{hadoop} & 1.0.0 & StringUtils.java  & 40 & 56 & 801987 & $M$  & 2013-02-04 \\
%			14 & \texttt{hadoop} & 1.0.0 & TestJobCounters.java  & 186 & 192 & 18833798 & $M$  & 2011-06-12 \\
%			15 & \texttt{hadoop} & 1.0.0 & TextOutputFormat.java  & 75 & 99 & 16928749 & $M$  & 2011-06-12 \\
%			16 & \texttt{hadoop} & 1.0.0 & WritableComparator.java  & 44 & 54 & 22315734 & $M$  & 2014-11-20 \\
...
%			22 & \texttt{jasperreports} & 3.7.4 & JRVerifier.java  & 982 & 998 & 8037824 & $M$  & 2008-04-17 \\
%			23 & \texttt{jasperreports} & 3.7.4 & JRVerifier.java  & 1221 & 1240 & 8037824 & $M$  & 2011-05-20 \\
%			24 & \texttt{jfreechart} & 1.0.13 & AbstractXYItemRenderer.java  & 532 & 569 & 12936580 & $M$  & 2016-02-19 \\
%			25 & \texttt{jfreechart} & 1.0.13 & KeyToGroupMap.java  & 18 & 30 & 16058183 & $M$  & 2013-07-03 \\
%			26 & \texttt{jfreechart} & 1.0.13 & SpiderWebPlot.java  & 502 & 520 & 21998949 & $M$  & 2008-06-02 \\
%			27 & \texttt{jfreechart} & 1.0.13 & SpiderWebPlot.java  & 522 & 536 & 21998949 & $M$  & 2008-06-02 \\
%			28 & \texttt{jgraph} & 5.13.0.0 & HelloWorld.java  & 16 & 22 & 6722760 & $R$  & 2014-04-13 \\
%			29 & \texttt{jgraph} & 5.13.0.0 & HelloWorld.java  & 28 & 40 & 6722760 & $R$  & 2014-04-13 \\
%			30 & \texttt{jgraph} & 5.13.0.0 & HelloWorld.java  & 31 & 36 & 6722760 & $R$  & 2014-04-13 \\
%			31 & \texttt{jgraph} & 5.13.0.0 & HelloWorld.java  & 39 & 56 & 6722760 & $R$  & 2014-04-13 \\
%			32 & \texttt{jstock} & 1.0.7c & GoogleMail.java  & 18 & 42 & 14940863 & $M$  & 2015-12-13 \\
%			33 & \texttt{jstock} & 1.0.7c & GoogleMail.java  & 18 & 42 & 24680923 & $M$  & 2015-12-13 \\
...
%			39 & poi & 3.6 & WorkbookFactory.java  & 18 & 28 & 12593810 & $M$  & 2015-04-29 \\
%			40 & \texttt{spring} & 3.0.5 & AnnotationMethodHandler \newline ExceptionResolver.java  & 224 & 233 & 5660519 & $D$  & 2012-01-20 \\
%			41 & \texttt{spring} & 3.0.5  & AutowireUtils.java  & 32 & 42 & 20913543 & $M$  & 2014-10-28 \\
%			42 & \texttt{spring} & 3.0.5  & CustomCollectionEditor.java  & 33 & 71 & 18623736 & $M$  & 2013-11-21 \\
%			43 & \texttt{spring} & 3.0.5  & DefaultAnnotation \newline HandlerMapping.java  & 78 & 92 & 3758110 & $D$  & 2012-01-20 \\
%			44 & \texttt{spring} & 3.0.5  & DefaultPropertiesPersister.java  & 69 & 80 & 6149818 & $M$  & 2013-03-19 \\
%			45 & \texttt{spring} & 3.0.5  & org.springframework.test/../ \newline DelegatingServletInputStream.java  & 6 & 20 & 20996373 & $M$  & 2016-07-15 \\
%			46 & \texttt{spring} & 3.0.5  & org.springframework.web/../ \newline DelegatingServletInputStream.java  & 6 & 20 & 20996373 & $M$  & 2008-12-18 \\
%			47 & \texttt{spring} & 3.0.5  & org.springframework.web.servlet/../ \newline DelegatingServletInputStream.java  & 6 & 20 & 20996373 & $M$  & 2008-12-18 \\
%			48 & \texttt{spring} & 3.0.5  & DispatcherServlet.java  & 91 & 103 & 4781746 & $M$  & 2011-08-08 \\
%			49 & \texttt{spring} & 3.0.5  & Jaxb2Marshaller.java  & 253 & 269 & 10924700 & $M$  & 2012-08-28 \\
%			50 & \texttt{spring} & 3.0.5  & ScheduledTasksBean \newline DefinitionParser.java  & 42 & 52 & 3751463 & $M$  & 2016-07-05 \\
%			51 & \texttt{struts2} & 2.2.1  & DefaultActionMapper.java  & 91 & 103 & 14019840 & $M$  & 2013-10-18 \\
%			52 & \texttt{tomcat} & 7.0.2  & BasicAuthenticator.java  & 25 & 73 & 21734562 & $M$  & 2016-08-04 \\
%			53 & \texttt{tomcat} & 7.0.2  & BasicAuthenticator.java  & 33 & 43 & 21734562 & $M$  & 2016-08-04 \\
%			54 & \texttt{tomcat} & 7.0.2  & CoyoteAdapter.java  & 543 & 553 & 24404964 & $M$  & 2012-11-18 \\
%			55 & \texttt{tomcat} & 7.0.2  & CoyoteAdapter.java  & 557 & 573 & 24404964 & $M$  & 2012-11-18 \\
%			56 & \texttt{tomcat} & 7.0.2  & FormAuthenticator.java  & 51 & 61 & 21734562 & $M$  & 2016-08-04 \\
%			57 & \texttt{tomcat} & 7.0.2  & HttpServlet.java  & 111 & 124 & 5266856 & $M$  & 2011-10-22 \\
%			58 & \texttt{tomcat} & 7.0.2  & JspRuntimeLibrary.java  & 252 & 296 & 10289462 & $M$  & 2012-09-12 \\
%		\hline
%	\end{tabular} %
%}
%\end{table*}
...
\begin{table*}
	...
	\small
	\resizebox{2.1\columnwidth}{!}{%
	\begin{tabular}{r|l|c|l|c|p{5.8cm}|r|r|c|c|c}
		\hline 
