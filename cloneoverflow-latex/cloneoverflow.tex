...
are presented in \Cref{tab:raw_stats}. $S_D$ reports 67,570 clone
...
\begin{table}
\caption{Investigated online clone pairs and snippets \FIXME{maybe
    merge with tables 7 and/or 9}}
\label{tab:snippets}
\centering
\begin{tabular}{l|rrrr}
  & Pairs & Snippets & Projects & Avg.~C$_{\textrm{\textit{\%}}}$ \\
\hline
...
\begin{table}
	\caption{Investigated online clone pairs and snippets (true positives without AC)}
	\label{tab:snippets_no_ac}
	\centering
	\begin{tabular}{l|rrrr}
		& Pairs & Snippets & Projects & Avg.~C$_{\textrm{\textit{\%}}}$ \\
		\hline
		\textit{good} & 136 & 47 & 25 & 23\% \\
		\textit{ok'} & 11,644 & 125 & 34 & 28\% \\
		$S_D'$ & 17,673 & 448 & 72 & 31\% \\
		$N_D'$ & 75 & 44 & 17 & 28\% \\
		\hline
...
we found that the manually investigated 31,946 clones pairs are clones
between 621 Stack Overflow snippets and 95 Qualitas projects.
...
\textbf{To answer RQ1, we found most Qualitas projects to share
  ...
  data set, between 82 to all 111 projects share similar code. This
  holds even for the investigated data set where 95 projects share
  code with Stack Overflow.}
