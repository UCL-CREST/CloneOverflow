...
\begin{table}[]
	\centering
	\caption{Licenses of 488 clone pairs in category A, B, and C}
	\label{tab:license_abc}
	\small
	\resizebox{\columnwidth}{!}{%
	\begin{tabular}{l|l|p{2.2cm}|r|r|r}
		\hline
		Type                 & SO          & Qualitas          & A & B & C \\
		\hline
		No license           & None        & None              & 18 & 61 & 1 \\
		\hline
		\multirow{3}{*}{Compatible} & Apache2     & Apache2    & 0  & 1  & 0 \\
		& EPLv1       & EPLv1                                  & 8  & 0  & 0 \\
		& CC BY 3.0   & CC BY 3.0                              & 0  & 17 & 0 \\
		\hline
		\multirow{14}{*}{Incompat.} & None        & Apache2    & 41 & 34 & 1 \\
		& None        & BSD3                                   & 0  & 1  & 0 \\
		& None        & CDDLorGPLv2                            & 0  & 62 & 1 \\
		& None        & EPLv1                                  & 6  & 0  & 0 \\
		& None        & GPLv2/2+/3+                            & 5  & 57 & 14 \\
		...
		& Sun (prop.) & None                                   & 0  & 21 & 0 \\
		& MIT         & None                                   & 0  & 0  & 1 \\
		& spdxBSD3/4  & None                                   & 0  & 0  & 0 \\ 
		& BSD3        & GPLv2+								   & 0  & 1  & 0 \\  
		\hline
		Total 	      &               &                       & 96 & 370 & 22 \\
		\hline
