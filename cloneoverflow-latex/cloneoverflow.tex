...
\textit{good} pairs (2,313) and the \textit{ok} pairs for
...
The classification of all 32,533 online clone pairs followed the steps
...
There were 3,636 pairs left for the manual check. The first author,
...
of the 3,636 clone pairs. By consulting the cloning patterns, the main
...
include 4, 44, 146, and 6 clone pairs from the \textit{good},
